...
export default function TruusVimeoHero() {
    ...
    return (
        <>
            <div ref={bubbleRef} className={`vimeo-mute-bubble ${isMuted ? 'is--muted' : 'is--unmuted'}`} style={{ pointerEvents: 'none' }}>
                <div className="vimeo-mute-bubble__blob">
                    <img src="/truus-assets/assets/VimeoHero SVG/mute-bubble-blob.svg" alt="" className="vimeo-mute-bubble__blob-svg" />
            ...
            <div className={`vimeo-hero ${isPlaying ? 'is-playing' : 'is-paused'} ${isMuted ? 'is-muted' : 'is-unmuted'}`} ref={playerRef} onClick={toggleMute}>
                <video ref={videoRef} autoPlay loop muted playsInline className="vimeo-hero__iframe" style={{ objectFit: 'cover', backgroundColor: '#111' }} />
                    ...
                    <h1 className="vimeo-hero__title" ref={titleRef} onClick={(e) => e.stopPropagation()}>
                        ...
                        <span className="vimeo-hero__word is--relative">
                            ...
                            <div className="home-header__smiley">
                                <img src="/truus-assets/assets/VimeoHero SVG/smiley-face.svg" alt="" className="home-header__smiley-svg" />
                            </div>
                        </span>
                        ...
                        <span className="vimeo-hero__word is--relative">
                            <div className="home-header__star">
                                <div className="home-header__star-inner">
                                    <img src="/truus-assets/assets/VimeoHero SVG/pink-star.svg" alt="" className="home-header__star-svg" />
                                </div>
                            </div>
                            <img src="/truus-assets/assets/VimeoHero SVG/oval-underline.svg" alt="" className="home-header__title-line-svg" />
