...
import { SOCIAL_ICONS, WIGGLE_CONFIG } from './data';
...
export default function TruusFooter() {
    useEffect(() => {
        ...
        const footerMapLink = document.querySelector('.truus-root .footer-map-link');
        if (footerMapLink) {
            ...
            const onLeave = () => {
                gsap.to(mapSvgPaths, { strokeDashoffset: 0, duration: 0.4, ease: 'power2.out', overwrite: true });
            };
        ...
        // Credits pop-out
        const creditsWrapper = document.querySelector('.truus-root .footer-credits-wrapper');
        if (creditsWrapper) {
            ...
            if (creditsBox && creditsItems) {
                ...
                const onLeave = () => {
                    ...
                    gsap.to(creditsBox, {
                        ...
                        ease: 'power3.in',
                        onComplete: () => {
                            gsap.set(creditsBox, { visibility: 'hidden' });
                        },
                    });
                    gsap.to(creditsItems, { y: fullHeight, duration: 0.4, ease: 'power3.in', stagger: -0.03, delay: 0.1 });
                };
        ...
        const footerStickers = gsap.utils.toArray<HTMLElement>('.truus-root .footer-sticker');
        ...
        gsap.to(footerStickers, {
            ...
            stagger: 0.12,
            scrollTrigger: {
                trigger: '.truus-root .footer-stickers',
                start: 'top 80%',
        ...
        const wiggleTargets = [
            { selector: '.truus-root .footer-column:first-child h3', key: 'jobHeading' as keyof typeof WIGGLE_CONFIG },
            { selector: '.truus-root .footer-map-link span', key: 'googleMap' as keyof typeof WIGGLE_CONFIG },
            { selector: '.truus-root .footer-email', key: 'email' as keyof typeof WIGGLE_CONFIG },
            { selector: '.truus-root .footer-whatsapp', key: 'whatsapp' as keyof typeof WIGGLE_CONFIG },
            { selector: '.truus-root .credits-name', key: 'socials' as keyof typeof WIGGLE_CONFIG },
        ];
        wiggleTargets.forEach(({ selector, key }) => {
            document.querySelectorAll(selector).forEach((el) => initWiggle(el, WIGGLE_CONFIG[key]));
        });
        document.querySelectorAll('.truus-root .single-social').forEach((el) => initWiggle(el, WIGGLE_CONFIG.socials));
    }, []);
            ...
            <div className="footer-bottom">
                ...
                <div className="footer-stickers">
                    <div className="footer-sticker sticker-smiley">
                        <img src="/truus-assets/assets/Footer-Sticker SVG/footer-sticker-smiley.svg" width="100%" alt="" aria-hidden="true" />
                    </div>
                    <div className="footer-sticker sticker-heart">
                        <img src="/truus-assets/assets/Footer-Sticker SVG/footer-sticker-heart.svg" width="100%" alt="" aria-hidden="true" />
                    </div>
                    <div className="footer-sticker sticker-hands">
                        <img src="/truus-assets/assets/Footer-Sticker SVG/footer-sticker-hands.svg" width="100%" alt="" aria-hidden="true" />
                    </div>
                    <div className="footer-sticker sticker-100">
                        <img src="/truus-assets/assets/Footer-Sticker SVG/footer-sticker-100.svg" width="100%" alt="" aria-hidden="true" />
                    </div>
                    <div className="footer-sticker sticker-camera">
                        <img src="/truus-assets/assets/Footer-Sticker SVG/footer-sticker-camera.svg" width="100%" alt="" aria-hidden="true" />
                    </div>
                    <div className="footer-sticker sticker-boom">
                        <img src="/truus-assets/assets/Footer-Sticker SVG/footer-sticker-boom.svg" width="100%" alt="" aria-hidden="true" />
                    </div>
                </div>
                        ...
                        <div className="credits-box">
                            <div className="credits-content">
                                <div className="credits-item credit-wiggle">
                                    ...
                                    <div className="overflow-wrapper">
                                        <a href="#" className="credits-name" data-wiggle-target="true">
                                            Jordan
                                        </a>
                                    </div>
                                </div>
