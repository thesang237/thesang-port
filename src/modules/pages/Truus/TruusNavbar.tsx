...
import { WIGGLE_CONFIG } from './data';

function initWiggle(element: Element, intensity: number) {
    const target = (element.querySelector('[data-wiggle-target]') || element) as Element;
...
export default function TruusNavbar() {
    useEffect(() => {
        const navbar = document.querySelector('.truus-root .navbar') as HTMLElement | null;
        const contentSection = document.querySelector('.truus-root .content-section') as HTMLElement | null;
        const footerEl = document.querySelector('.truus-root .main-footer') as HTMLElement | null;
        ...
        const updateNavbarColor = () => {
            ...
            const showreelSection = document.querySelector('.truus-root #showreel-section');
            const showreelTop = showreelSection ? showreelSection.getBoundingClientRect().top + window.scrollY : Infinity;
            const serviceCardsSection = document.querySelector('.truus-root .service-cards-wrapper');
            const serviceCardsTop = serviceCardsSection ? serviceCardsSection.getBoundingClientRect().top + window.scrollY : Infinity;
            const doubleMarquee = document.querySelector('.truus-root .Double-marquee');
        ...
        const logoTruus = document.querySelector('.truus-root .logo-truus');
        if (logoTruus) cleanups.push(initWiggle(logoTruus, WIGGLE_CONFIG.logoTruus));

        const overlay = document.querySelector('.truus-root .nav-overlay') as HTMLElement | null;
        ...
        // Left nav (work) hover
        const navLeft = document.querySelector('.truus-root .nav-left');
        const workBox = document.querySelector('.truus-root .nav-work-box') as HTMLElement | null;
        const workBlob = document.querySelector('.truus-root .nav-bar__work-blob-svg') as HTMLElement | null;
        ...
        if (navLeft && workBox && workBlob) {
            ...
            const onLeaveLeft = () => {
                ...
                gsap.to(workBox, {
                    ...
                    delay: 0.05,
                    onComplete: () => {
                        gsap.set(workBox, { visibility: 'hidden' });
                    },
                });
            };
        ...
        // Right nav (whatsapp) hover
        const navRight = document.querySelector('.truus-root .nav-right');
        const waBox = document.querySelector('.truus-root .nav-wa-box') as HTMLElement | null;
        const waIcon = document.querySelector('.truus-root .nav-bar__whatsapp-svg') as HTMLElement | null;
        const waSvgPath = document.querySelector('.truus-root .nav-bar__whatsapp-svg path') as SVGPathElement | null;
        ...
        if (navRight && waBox) {
            ...
            const onLeaveRight = () => {
                ...
                gsap.to(waBox, {
                    ...
                    delay: 0.05,
                    onComplete: () => {
                        gsap.set(waBox, { visibility: 'hidden' });
                    },
                });
            };
        ...
        // Work item hover: badge wiggle + image tilt
        const workItems = document.querySelectorAll('.truus-root .nav-work-item');
        ...
        // "All Our Work" btn wiggle
        const workBtn = document.querySelector('.truus-root .nav-work-btn');
        if (workBtn) {
            let btnWiggle: gsap.core.Tween | null = null;
            const onBtnEnter = () => {
    ...
    return (
        <>
            ...
            <nav className="navbar">
                <div className="nav-left" style={{ cursor: "url('/truus-assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        <div className="logo-work-container">
                            <img src="/truus-assets/assets/Navbar SVG/nav-work-blob.svg" width="60" height="55" className="nav-bar__work-blob-svg" alt="" aria-hidden="true" />
                            ...
                            <div className="nav-popout-inner">
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img
                                            src="https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/68a46f25779a71fac3a11903_SnapInsta.jpg"
                                            loading="eager"
                                            alt="Feestje bouwe? App Douwe"
                                ...
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img
                                            src="https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/6880a344675f3a6144ed04df_01_HEMA_Back2School.avif"
                                            loading="eager"
                                            alt="Skibidi school"
                                            className="nav-work-item__img"
                                        />
                                ...
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img
                                            src="https://cdn.prod.website-files.com/683863cbe1f5a81b667b9939/686b7e0ed3ab3045b28a2012_3.avif"
                                            loading="eager"
                                            alt="Hema socials"
                                            className="nav-work-item__img"
                                        />
                ...
                <div className="nav-center" style={{ cursor: "url('/truus-assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                ...
                <div className="nav-right" style={{ cursor: "url('/truus-assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        ...
                        <div className="nav-popout nav-wa-box">
                            <div className="nav-popout-inner">
                                <img src="/truus-assets/assets/wa_qr_code.png" className="nav-wa-qr" alt="WhatsApp QR Code" />
