...
export default function SvgMorphPage() {
    ...
    return (
        ...
        >
            <svg ref={containerRef} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 760 400" style={{ maxWidth: '1200px' }}>
                <defs>
